...
def load_network_file(network_file_path, params=None):
	# Load or set network loading parameters
	if params is None:
		delimiter = '\t'
		...
		delimiter = params['net_filedelim']
		degree_shuffle = params['degree_preserved_shuffle']
		label_shuffle = params['node_label_shuffle']
...
def load_binary_mutation_data(filename, params=None):
	...
	if params is None:
		...
		delimiter = params['mut_filedelim']
		verbose = params['verbose']
